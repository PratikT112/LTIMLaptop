...
public class Solution {
    ...
    */
    ...
    public static void testMember() {
        ...
        assert testMember.getId() == 1 :
                "member ID should be 1, was " + testMember.getId();
        assert testMember.getName().equals("John Doe") :
                "member name should be \"John Doe\", was \"" + testMember.getName() + "\"";
        assert testMember.getMembershipStatus() == MembershipStatus.BRONZE :
                "membership status should be BRONZE, was " + testMember.getMembershipStatus();
    }
    ...
    public static void testMembership() {
        ...
        assert testMembership.members.get(0).getMembershipStatus() == MembershipStatus.SILVER :
                "membership status should be SILVER, was " + testMembership.members.get(0).getMembershipStatus();
